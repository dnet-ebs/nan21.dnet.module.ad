...
/* model */
Ext.define(Dnet.ns.ad + "User_UserGroup_Asgn$Model", {
...
/* lists */
Ext.define( Dnet.ns.ad + "User_UserGroup_Asgn$List", {
	extend: "dnet.core.asgn.AbstractAsgnGrid",
	alias:[ "widget.ad_User_UserGroup_Asgn$Left","widget.ad_User_UserGroup_Asgn$Right" ],
...
/* ui-window */
Ext.define(Dnet.ns.ad + "User_UserGroup_Asgn$Ui", {
	...
	_defineElements_: function () {
		this._getBuilder_()
			.addLeftGrid({ xtype:"ad_User_UserGroup_Asgn$Left"})
			.addRightGrid({ xtype:"ad_User_UserGroup_Asgn$Right"})
	}
});
