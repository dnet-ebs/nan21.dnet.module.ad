...
/* model */
Ext.define(Dnet.ns.ad + "Menu_Role_Asgn$Model", {
...
/* lists */
Ext.define( Dnet.ns.ad + "Menu_Role_Asgn$List", {
	extend: "dnet.core.asgn.AbstractAsgnGrid",
	alias:[ "widget.ad_Menu_Role_Asgn$Left","widget.ad_Menu_Role_Asgn$Right" ],
...
/* ui-window */
Ext.define(Dnet.ns.ad + "Menu_Role_Asgn$Ui", {
	...
	_defineElements_: function () {
		this._getBuilder_()
			.addLeftGrid({ xtype:"ad_Menu_Role_Asgn$Left"})
			.addRightGrid({ xtype:"ad_Menu_Role_Asgn$Right"})
	}
});
