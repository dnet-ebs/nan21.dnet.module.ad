...
/* model */
Ext.define(Dnet.ns.ad + "UserGroup_User_Asgn$Model", {
...
/* lists */
Ext.define( Dnet.ns.ad + "UserGroup_User_Asgn$List", {
	extend: "dnet.core.asgn.AbstractAsgnGrid",
	alias:[ "widget.ad_UserGroup_User_Asgn$Left","widget.ad_UserGroup_User_Asgn$Right" ],
...
/* ui-window */
Ext.define(Dnet.ns.ad + "UserGroup_User_Asgn$Ui", {
	...
	_defineElements_: function () {
		this._getBuilder_()
			.addLeftGrid({ xtype:"ad_UserGroup_User_Asgn$Left"})
			.addRightGrid({ xtype:"ad_UserGroup_User_Asgn$Right"})
	}
});
