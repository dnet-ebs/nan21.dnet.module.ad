 ...
 */
Ext.define(Dnet.ns.ad + "Role_Dc" , {
	extend: "dnet.core.dc.AbstractDc",
	recordModel: Dnet.ns.ad + "Role_Ds"
});

/* ================= FILTER FORM: Filter ================= */			

Ext.define(Dnet.ns.ad + "Role_Dc$Filter" , {
	...
	_defineElements_: function() {
		...
		/* =========== controls =========== */
		.addLov({name:"code", dataIndex:"code", xtype:"ad_Roles_Lov", caseRestriction:"uppercase",
...
Ext.define(Dnet.ns.ad + "Role_Dc$EditList" , {
